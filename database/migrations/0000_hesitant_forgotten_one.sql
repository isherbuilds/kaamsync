...
CREATE TABLE "subscriptions" (
	...
	"pre_tax_amount" integer,
	"purchased_seats" integer DEFAULT 0 NOT NULL,
	"purchased_storage_gb" integer DEFAULT 0 NOT NULL,
...
CREATE INDEX "subscriptions_billing_customer_idx" ON "subscriptions" USING btree ("billing_customer_id");--> statement-breakpoint
...
CREATE INDEX "timelines_user_idx" ON "timelines" USING btree ("user_id");