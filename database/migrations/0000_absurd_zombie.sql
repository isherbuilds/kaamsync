...
CREATE INDEX "matters_org_deleted_idx" ON "matters" USING btree ("org_id","deleted_at");--> statement-breakpoint
...
CREATE INDEX "organizations_usage_matters_idx" ON "organizations_table" USING btree ((usage->>'matters')::int);--> statement-breakpoint
CREATE INDEX "organizations_plan_key_idx" ON "organizations_table" USING btree ("plan_key");--> statement-breakpoint
...
CREATE INDEX "statuses_team_deleted_idx" ON "statuses" USING btree ("team_id","deleted_at");--> statement-breakpoint
CREATE INDEX "subscriptions_customer_idx" ON "subscriptions" USING btree ("billing_customer_id");--> statement-breakpoint
CREATE INDEX "subscriptions_org_idx" ON "subscriptions" USING btree ("organization_id");--> statement-breakpoint
CREATE INDEX "subscriptions_status_idx" ON "subscriptions" USING btree ("status");--> statement-breakpoint
CREATE UNIQUE INDEX "subscriptions_dodo_idx" ON "subscriptions" USING btree ("billing_subscription_id");--> statement-breakpoint
...
CREATE INDEX "team_memberships_team_user_deleted_idx" ON "team_memberships" USING btree ("team_id","user_id","deleted_at");--> statement-breakpoint
