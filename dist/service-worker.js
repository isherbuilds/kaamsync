		...
		return (
			...
			this._headers &&
				...
				(t = Object.keys(this._headers).some(
					(s) => e.headers.get(s) === this._headers[s],
				)),
			t
		);
	}
...
class v {
	constructor(e) {
		(this.cacheWillUpdate = async ({ response: t }) =>
			...
			(this._cacheableResponse = new D(e));
	}
}
const H = new Set(),
	f = {
...
function J(a) {
	...
	return s.searchParams.set(z, e), { cacheKey: s.href, url: n.href };
}
class X {
	constructor() {
		(this.updatedURLs = []),
...
class Z {
	...
	async cachePut(e, t) {
		...
		if (!t) throw new l("cache-put-with-no-response", { url: A(n.url) });
		...
		const { cacheName: c, matchOptions: i } = this._strategy,
			...
			p = h ? await F(o, n.clone(), ["__WB_REVISION__"], i) : null;
		try {
...
d.copyRedirectedCacheableResponsesPlugin = {
	async cacheWillUpdate({ response: a }) {
		return a.redirected ? await V(a) : a;
	},
};
class ee {
	constructor({
...
let w;
const E = () => (
	w || ((w = new se()), w.addFetchListener(), w.addCacheListener()), w
);
function P(a, e, t) {
	let s;
	if (typeof a == "string") {
...
class de extends k {
	...
	async _handle(e, t) {
		...
		const i = await t.waitUntil(
			(async () => (await t.waitUntil(Promise.race(n))) || (await c))(),
		);
...
self.addEventListener("install", (a) => {
	a.waitUntil(
		Promise.all([
			self.skipWaiting(),
			caches.open(I).then((e) =>
				Promise.all(
					O.map((t) =>
						fetch(t, { cache: "reload" })
							.then((s) => {
								s.ok && e.put(t, s);
							})
							.catch(() => {}),
...
self.addEventListener("message", (a) => {
	a.data === "SKIP_WAITING" && self.skipWaiting();
});
Q({ prefix: "KaamSync" });
ue([
	{ revision: "d319f92f2a19cded0d6919969adba0e0", url: "index.html" },
	{ revision: "f4706ad25b9e9ca9720932652ec342ca", url: "favicon.ico" },
	{ revision: "814086a9d075bb5113f8603501d5af57", url: "signup/index.html" },
	{ revision: "ecc31dc41c1a075e46bcf63547320814", url: "login/index.html" },
	{ revision: null, url: "assets/zap-CcLevXKd.js" },
	{ revision: null, url: "assets/x-q-8NcLqU.js" },
	{ revision: null, url: "assets/teams._teamCode.members-BS_R6i91.js" },
	{ revision: null, url: "assets/teams._teamCode-CflsYkI2.js" },
	{ revision: null, url: "assets/workbox-window.prod.es5-BIl4cyR9.js" },
	{ revision: null, url: "assets/virtualized-list-PslJPldC.js" },
	{ revision: null, url: "assets/virtual_pwa-register-mbs_Wgpn.js" },
	{ revision: null, url: "assets/users-B4xjkfFp.js" },
	{ revision: null, url: "assets/user-plus-CpeQDUeF.js" },
	{ revision: null, url: "assets/user-C7wRckv2.js" },
	{ revision: null, url: "assets/use-loader-data-aoiHAPHK.js" },
	{ revision: null, url: "assets/under-construction-ClrZUM4t.js" },
	{ revision: null, url: "assets/textarea-ChZsIiFA.js" },
	{ revision: null, url: "assets/tasks-DJEKrpex.js" },
	{ revision: null, url: "assets/stable-link-CigVIdCe.js" },
	{ revision: null, url: "assets/sparkles-Du1TKMOs.js" },
	{ revision: null, url: "assets/signup-main-B16FUcPb.js" },
	{ revision: null, url: "assets/signup-client-action-CMsSIb3Y.js" },
	{ revision: null, url: "assets/sidebar-B2qZdcv6.js" },
	{ revision: null, url: "assets/shield-qfxOCDzp.js" },
	{ revision: null, url: "assets/shield-check-CD9YehC9.js" },
	{ revision: null, url: "assets/send-Dl-ZwKxc.js" },
	{ revision: null, url: "assets/schemas-BS7t07Ll.js" },
	{ revision: null, url: "assets/root-jmnuvSMl.js" },
	{ revision: null, url: "assets/root-e4hM9CUp.css" },
	{ revision: null, url: "assets/requests-C2tz_HEV.js" },
	{ revision: null, url: "assets/reload-error-handler-CLnQzbRr.js" },
	{ revision: null, url: "assets/query-l0sNRNKZ.js" },
	{ revision: null, url: "assets/query-cache-policy-YO8rlQDc.js" },
	{ revision: null, url: "assets/pricing-DGoC48Jv.js" },
	{ revision: null, url: "assets/preload-helper-BXl3LOEh.js" },
	{ revision: null, url: "assets/parse-BkjlzDno.js" },
	{ revision: null, url: "assets/organization-C6hI8PIQ.js" },
	{ revision: null, url: "assets/offline-auth-DpP3EZXd.js" },
	{ revision: null, url: "assets/mutators-Cjlcgbnw.js" },
	{ revision: null, url: "assets/mutate-l0sNRNKZ.js" },
	{ revision: null, url: "assets/message-square-DhAHrEDE.js" },
	{ revision: null, url: "assets/members-D9jrLe9R.js" },
	{ revision: null, url: "assets/matter._matterKey-main-pJOCqhOE.js" },
	{ revision: null, url: "assets/matter._matterKey-client-loader-Cvq0E6ut.js" },
	{ revision: null, url: "assets/matter-field-selectors-CcZEtb_2.js" },
	{ revision: null, url: "assets/matter-constants-HvmqGJW4.js" },
	{ revision: null, url: "assets/manifest-6864d339.js" },
	{ revision: null, url: "assets/mail-DgH-ztar.js" },
	{ revision: null, url: "assets/logout-client-action-CZAks5MO.js" },
	{ revision: null, url: "assets/logout-B8VyXSLL.js" },
	{ revision: null, url: "assets/login-main-BJVU1H8h.js" },
	{ revision: null, url: "assets/login-client-action-CA4IiMCq.js" },
	{ revision: null, url: "assets/loader-circle-jhSsV45S.js" },
	{ revision: null, url: "assets/lazy-inspector-Cq1gjcN9.js" },
	{ revision: null, url: "assets/layout-main-Dk3z-dRo.js" },
	{ revision: null, url: "assets/layout-constants-CjVvez-T.js" },
	{ revision: null, url: "assets/layout-client-middleware-DExhV_oL.js" },
	{ revision: null, url: "assets/layout-client-loader-D-SvKq66.js" },
	{ revision: null, url: "assets/layout-client-loader-BLCRcGrm.js" },
	{ revision: null, url: "assets/layout-D8VSg83M.js" },
	{ revision: null, url: "assets/layout-C8nJMkwZ.js" },
	{ revision: null, url: "assets/layout-C-jOWS3L.js" },
	{ revision: null, url: "assets/label-IyzchuuN.js" },
	{ revision: null, url: "assets/jsx-runtime-u17CrQMm.js" },
	{ revision: null, url: "assets/join-3aLsJbSG.js" },
	{ revision: null, url: "assets/integrations-DGPydGzS.js" },
	{ revision: null, url: "assets/input-D43rd-k9.js" },
	{ revision: null, url: "assets/index-k85W11Qe.js" },
	{ revision: null, url: "assets/index-Dh1KZgBw.js" },
	{ revision: null, url: "assets/index-DIqdcrKi.js" },
	{ revision: null, url: "assets/index-D2WGDGSS.js" },
	{ revision: null, url: "assets/index-BtDFNxjm.js" },
	{ revision: null, url: "assets/index-BZKi-ofB.js" },
	{ revision: null, url: "assets/index-BVutx1Oq.js" },
	{ revision: null, url: "assets/icons-DdbgxWVU.js" },
	{ revision: null, url: "assets/home-DwBtxYFe.js" },
	{ revision: null, url: "assets/helpers-DYqDQke1.js" },
	{ revision: null, url: "assets/helpers-BSuDXJ4w.js" },
	{ revision: null, url: "assets/general-71KnjxBc.js" },
	{ revision: null, url: "assets/forms-XryVTPuK.js" },
	{ revision: null, url: "assets/entry.client-Dr3VkB6X.js" },
	{ revision: null, url: "assets/ellipsis-C3baGhGI.js" },
	{ revision: null, url: "assets/dropdown-menu-CvnKu5ji.js" },
	{ revision: null, url: "assets/dialog-j7bGAzQX.js" },
	{ revision: null, url: "assets/createLucideIcon-Dmc_JDiN.js" },
	{ revision: null, url: "assets/contact-T0NZxl82.js" },
	{ revision: null, url: "assets/constraint-BXJdBpqq.js" },
	{ revision: null, url: "assets/components-COP-ApS7.js" },
	{ revision: null, url: "assets/compiler-runtime-BxvNalec.js" },
	{ revision: null, url: "assets/color-scheme-l0sNRNKZ.js" },
	{ revision: null, url: "assets/collect-idb-databases-BtiYF-db.js" },
	{ revision: null, url: "assets/clock-B2i2LZG2.js" },
	{ revision: null, url: "assets/circle-check-BUljwZA5.js" },
	{ revision: null, url: "assets/chunk-JMJ3UQ3L-CyisSclS.js" },
	{ revision: null, url: "assets/chevron-left-6uLnLC2Y.js" },
	{ revision: null, url: "assets/chevron-down-C9qmpTsC.js" },
	{ revision: null, url: "assets/check-CQv8cul9.js" },
	{ revision: null, url: "assets/calendar-WUqCR9k0.js" },
	{ revision: null, url: "assets/button-DEqWk81C.js" },
	{ revision: null, url: "assets/building-2-C_4gqMN-.js" },
	{ revision: null, url: "assets/billing-DVdGc5Bp.js" },
	{ revision: null, url: "assets/better-l0sNRNKZ.js" },
	{ revision: null, url: "assets/better-error-DiwjGRVz.js" },
	{ revision: null, url: "assets/badge-DILxRVfb.js" },
	{ revision: null, url: "assets/avatar-DzEK6QqI.js" },
	{ revision: null, url: "assets/auth-client-CWNy-5yc.js" },
	{ revision: null, url: "assets/auth-DwXnu30e.js" },
	{ revision: null, url: "assets/app-config-Ch19K2Ek.js" },
	{ revision: null, url: "assets/about-30QRo_M6.js" },
	{ revision: null, url: "assets/_teamCode-BwD-jZtn.js" },
	{ revision: "f4706ad25b9e9ca9720932652ec342ca", url: "favicon.ico" },
	{ revision: "c7e832c6e4b93a42487ea0d28eeb7568", url: "manifest.webmanifest" },
]);
le();
P(
...
P(
	({ request: a }) =>
		...
		a.destination === "style" ||
		a.destination === "font",
	new pe({ cacheName: ge, plugins: [new v({ statuses: [0, 200] })] }),
);
fe(async ({ request: a }) => {
	if (a.mode === "navigate")
		for (const e of O) {
